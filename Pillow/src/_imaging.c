...
extern PyObject *
PyImaging_PgfDecoderNew(PyObject *self, PyObject *args);
extern PyObject *
...
/*extern PyObject *
PyImaging_PgfEncoderNew(PyObject *self, PyObject *args);*/
extern PyObject *
...
#ifdef HAVE_PGF
    {"pgf_decoder", (PyCFunction)PyImaging_PgfDecoderNew, 1},
//    {"pgf_encoder", (PyCFunction)PyImaging_PgfEncoderNew, 1},
#endif
...
#ifdef HAVE_PGF
    {
        extern const char *ImagingPgfVersion(void);
        PyDict_SetItemString(
            d, "pgf_version", PyUnicode_FromString(ImagingPgfVersion()));
    }
#endif
