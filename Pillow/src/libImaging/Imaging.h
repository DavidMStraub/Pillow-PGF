...
ImagingPgfDecode(
    Imaging im, ImagingCodecState state, UINT8 *buffer, Py_ssize_t bytes);
extern int
ImagingPgfDecodeCleanup(ImagingCodecState state);
/*
extern int
ImagingPgfEncode(Imaging im, ImagingCodecState state, UINT8 *buffer, int bytes);
extern int
ImagingPgfEncodeCleanup(ImagingCodecState state);
*/
#endif
