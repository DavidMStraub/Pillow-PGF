...
deps = {
    "libpgf": {
        "url": "https://sourceforge.net/projects/libpgf/files/libpgf/7.21.2/libpgf.zip",
        "filename": "libpgf.zip",
        "dir": "libpgf-7.21.2",
        "build": [
            cmd_msbuild("PGFCodec.sln", "ReleaseOMP", "Clean"),
            cmd_msbuild("PGFCodec.sln", "ReleaseOMP", "Build"),
            cmd_xcopy(r"include\*.h", "{inc_dir}"),
            cmd_copy(r"lib\x64\PGFCodecOMP.lib", r"lib\x64\libpgf.lib"),
        ],
        "libs": [r"lib\x64\libpgf.lib"],
    },
    "libjpeg": {
